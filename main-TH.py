...
def redq_sac(env_name, seed=0, epochs='mbpo', steps_per_epoch=1000,
    ...
    agent = REDQSACAgent(env_name, obs_dim, act_dim, act_limit, device,
                 ...
                 policy_update_delay,
                         ...
                         turn_over_dropout_rate=turn_over_dropout_rate, # added by TH 20221014
                         apply_only_last_layer_Q=apply_only_last_layer_Q, # added by TH 20221107
                         apply_only_last_layer_Policy=apply_only_last_layer_Policy, # added by TH20221107
...
if __name__ == '__main__':
    ...
    # added by TH 20221014
    parser.add_argument("-turn_over_dropout_rate",  type=float, default=0.0,
                        help="Using turn over dropout (and activating additional analyses) if set to > 0.0 (TH), default=0.0")
    ...
    parser.add_argument("-apply_only_at_last_Q",  nargs="*", type=str, default=[],
                        help="list of operation applied only at last layer in Q networks. An element should be either of ToD, DO, LN. "
                             "This argument is given like \"ToD LN\" , default=\"[]\"")
    parser.add_argument("-apply_only_at_last_Pol",  nargs="*", type=str, default=[],
                        help="list of operation applied only at last layer in policy networks. An element should be either of ToD, DO, LN. "
                             "This argument is given like \"ToD LN\" , default=\"[]\"")
    ...
    redq_sac(args.env, seed=args.seed, epochs=args.epochs,
             ...
             method=args.method,
             turn_over_dropout_rate=args.turn_over_dropout_rate, # TH20221014
             apply_only_last_layer_Q=args.apply_only_at_last_Q, # TH20221107
             apply_only_last_layer_Policy=args.apply_only_at_last_Pol,
